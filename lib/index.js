  ...
  _createClass(TextRemark, [{
    ...
    value: function addEvents() {
      ...
      this.$container.addEventListener('mousedown', function (e) {
        _this.$container.classList.add('mousedown');
        ...
        if ($target && $target.classList.contains('text-remark-tag')) {
          ...
          _this.dispatchEvent('tag-selected', {
            target: e.target,
            tagType: tagType,
            remark: _objectSpread({}, _this.remarks[index])
          });
        }
      }, false);
      this.$container.addEventListener('mouseup', function (e) {
        _this.$container.classList.remove('mousedown');

        _this.startSelect = false;

        _this.mySelection(e);
      }, false);
      this.$realText.addEventListener('mousemove', function (e) {
        if (_this.startSelect) {
          _this.mySelection(e);
        }
      }, false);
    }
